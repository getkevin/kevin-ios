...
open class KevinTheme {
    ...
    public struct NotSupportedCountryStyle {
        ...
        public var iconColor = UIColor(red: 93/255, green: 128/255, blue: 254/255, alpha: 1)
    ...
    open var notSupportedCountryStyle = NotSupportedCountryStyle()
